   ...
   pong () {
     ...
     this.pingTimeout = setTimeout(() => {
       if (
         ...
         // appropriately.
         console.log(`${this.logPrefix} Connection timeout, pong failed`)
     ...
     await authApi.getOneShot()
       ...
       .then((token) => {
         ...
         this.connection.onclose = (e) => {
          console.log(`${this.logPrefix} Connection closed:`, e)
           clearTimeout(this.pingTimeout)
         ...
         this.connection.onerror = (e) => {
          console.log(`${this.logPrefix} Connection error:`, e)
         ...
         this.connection.onmessage = (m) => {
           ...
           if (d.error) { // Is it in error?
             ...
             console.log(`${this.logPrefix} Response error:`, d.error)
